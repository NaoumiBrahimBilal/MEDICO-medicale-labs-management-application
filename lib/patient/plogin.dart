...
// ignore_for_file: unused_label, unused_local_variable, unused_import
...
class _LoginState extends State<plogin> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('patients Login Page'),
        centerTitle: true, 
              ...
              child: SingleChildScrollView( 
                child: Column(
                  ...
                  UserCredential userCredential = await FirebaseAuth.instance.signInWithEmailAndPassword(
                   ...
                   bool exists=  await MongoDatabase.pemailExists(emailController.text, passwordController.text);
                   if(exists){
                 ...
                 // print(userCredential.user!.uid);
                  ...
                  Navigator.pushReplacementNamed(context, '/patacceuil');
                   }
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Invalid email or password')));
                    ...
                    SizedBox(height: 20),
                    TextButton(
                      onPressed: () => Navigator.pushNamed(context, '/pregister'),
